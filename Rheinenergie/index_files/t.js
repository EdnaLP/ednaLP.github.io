...
et_addEvent(
    ...
    },
    {
        "name": "External Link",
        "type": "externalLink",
        "pattern": "(?!mailto:)(?!javascript:)(?!^(https?:\\\/\\\/)?(.*\\.)?(wwwtest\\.rheinenergie\\.com|rheinenergie\\.com|rheinenergie\\.com|twitter\\.com|xing\\.com|linkedin\\.com|youtube\\.com|facebook\\.com|instagram\\.com|pinterest\\.com|tumblr\\.com))(^.*$)"
    },
    {
        "name": "Mailto Link",
        "type": "mailToLink",
    ...
    },
    {
        "name": "document",
        "type": "download",
        "pattern": "^(https?:\\\/\\\/)?(www\\.)?(.*\\.)?(wwwtest\\.rheinenergie\\.com|rheinenergie\\.com|rheinenergie\\.com).+\\.doc$|\\.docx$|\\.docm$|\\.dotm$|\\.dotx$|\\.dot$|\\.odt$|\\.pages$"
    },
    {
        "name": "excel",
        "type": "download",
        "pattern": "^(https?:\\\/\\\/)?(www\\.)?(.*\\.)?(wwwtest\\.rheinenergie\\.com|rheinenergie\\.com|rheinenergie\\.com).+\\.xls$|\\.xlsx$|\\.xlsm$|\\.xltm$|\\.xltx$|\\.xml$|\\.xlsb$|\\.ods$|\\.numbers$"
    },
    {
        "name": "powerpoint",
        "type": "download",
        "pattern": "^(https?:\\\/\\\/)?(www\\.)?(.*\\.)?(wwwtest\\.rheinenergie\\.com|rheinenergie\\.com|rheinenergie\\.com).+\\.ppt$|\\.pptx$|\\.pptm$|\\.pot$|\\.potx$|\\.potm$|\\.odp$|\\.key$"
    },
    {
        "name": "pdf",
        "type": "download",
        "pattern": "^(https?:\\\/\\\/)?(www\\.)?(.*\\.)?(wwwtest\\.rheinenergie\\.com|rheinenergie\\.com|rheinenergie\\.com).+\\.pdf$"
    }
];
...
var et_deliveryHash = "TV8/uBkGhkQART5W4kMfEufrv1N0WZ3M";

var cc_autoPageNameRegistration = 'title';
var cc_getParamsWhiteList = [];
ET_Event = new etEvent("YKgUXE", et_server);
...
var cc_deltaTime 	= 15913485637344-(new Date().getTime()*10);
...
})();function _etc_start()
{
	...
	etCommerce.etCommerceLoad('YKgUXE');
	etCommerce.doPreparedEvents();        et_setupPageExitBeacon('YKgUXE');
